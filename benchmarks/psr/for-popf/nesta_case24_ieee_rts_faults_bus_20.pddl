(define (problem test)
  ...
  (:init
    ...
    (closed branch_02_bus_01_bus_05)
    (= (switch_state branch_02_bus_01_bus_05) 1)
    (ends branch_03_bus_02_bus_04 bus_02 bus_04)
    (closed branch_03_bus_02_bus_04)
    (= (switch_state branch_03_bus_02_bus_04) 1)
    (ends branch_04_bus_02_bus_06 bus_02 bus_06)
    (closed branch_04_bus_02_bus_06)
    (= (switch_state branch_04_bus_02_bus_06) 1)
    ...
    (closed branch_10_bus_07_bus_08)
    (= (switch_state branch_10_bus_07_bus_08) 1)
    ...
    (closed branch_17_bus_11_bus_13)
    (= (switch_state branch_17_bus_11_bus_13) 1)
    (ends branch_18_bus_11_bus_14 bus_11 bus_14)
    (closed branch_18_bus_11_bus_14)
    (= (switch_state branch_18_bus_11_bus_14) 1)
    (ends branch_19_bus_12_bus_13 bus_12 bus_13)
    (closed branch_19_bus_12_bus_13)
    (= (switch_state branch_19_bus_12_bus_13) 1)
    (ends branch_20_bus_12_bus_23 bus_12 bus_23)
    (closed branch_20_bus_12_bus_23)
    (= (switch_state branch_20_bus_12_bus_23) 1)
    ...
    (closed branch_26_bus_15_bus_24)
    (= (switch_state branch_26_bus_15_bus_24) 1)
    ...
    (open branch_28_bus_16_bus_19)
    (= (switch_state branch_28_bus_16_bus_19) 0)
    ...
    (open branch_35_bus_20_bus_23)
    (= (switch_state branch_35_bus_20_bus_23) 0)
    (ends branch_36_bus_20_bus_23 bus_20 bus_23)
    (open branch_36_bus_20_bus_23)
    (= (switch_state branch_36_bus_20_bus_23) 0)
