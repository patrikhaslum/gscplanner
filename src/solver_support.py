...
configs = [  'blind', 'iw_1', 'iw_2', 'bfs_f_1', 'bfs_f_2', 'a_star_h0', 'a_star_hmax', 'a_star_hplus', 'ppa_star_hplus', 'ppa_star_hplus_r1', 'ppa_star_hplus_ngl','ppa_star_hplus_ngl2', 'restarting_ppa_star_hplus',
